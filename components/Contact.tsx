...
export default function Contact() {
  ...
  const CONTACT_ITEMS = [
    { icon: Phone,  label: txt.phoneLabel,    value: '+230 5813 7384',                 href: 'https://wa.me/23058137384' },
    { icon: Mail,   label: txt.emailLabel,    value: 'contact@islandproconsulting.mu', href: 'mailto:contact@islandproconsulting.mu' },
    { icon: MapPin, label: txt.locationLabel, value: txt.locationValue,                href: '#' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <a href="https://wa.me/23058137384?text=Hello%20Island%20Pro%20Consulting%2C%20I%20am%20interested%20in%20your%20services."
              ...
              <MessageCircle size={16} /> {txt.whatsapp}
            </a>
          </div>
          ...
          <div className="bg-white rounded-3xl border border-navy/8 p-8 shadow-card">
            <ContactForm
              ...
              dropdownLabel={txt.formDropdown}
              dropdownOptions={txt.dropdownOptions as unknown as string[]}
              messagePlaceholder={txt.formPlaceholder}
              submitLabel={txt.formSubmit}
            />
          </div>
        </div>
      </div>
