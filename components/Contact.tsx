        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl lg:text-5xl font-black text-navy tracking-tight leading-tight mb-5">
              ...
              <span className="gold-text">business further?</span>
            </h2>
              ...
              {[
                ...
                return (
                  <a key={c.label} href={c.href} target="_blank" rel="noopener noreferrer"
                    ...
                    <div className="w-11 h-11 rounded-2xl bg-navy/5 flex items-center justify-center flex-shrink-0 group-hover:bg-gold/10 transition-colors">
                      <Icon size={18} className="text-navy/60 group-hover:text-gold-dark transition-colors" />
                    </div>
                    <div>
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input type="text" required placeholder="Jean-Marc Dupont"
                      className="px-4 py-3 text-sm border border-navy/15 rounded-xl bg-cream outline-none focus:border-gold focus:ring-2 focus:ring-gold/10 transition-all" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <select required
                    className="px-4 py-3 text-sm border border-navy/15 rounded-xl bg-cream outline-none focus:border-gold focus:ring-2 focus:ring-gold/10 transition-all appearance-none">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea required rows={4} placeholder="Tell us about your project..."
                    className="px-4 py-3 text-sm border border-navy/15 rounded-xl bg-cream outline-none focus:border-gold focus:ring-2 focus:ring-gold/10 transition-all resize-none" />
                </div>

                <button type="submit" disabled={loading}
                  className="w-full flex items-center justify-center gap-2 bg-navy text-white font-bold text-sm py-3.5 rounded-xl hover:bg-navy-mid transition-all disabled:opacity-60 mt-2">
                  {loading
