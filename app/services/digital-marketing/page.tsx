...
const T: Record<Lang, {
  ...
  industriesH2: string;
  industriesPara: string;
  industries: string[];
  ourApproachBadge: string;
  ourApproachH2Line1: string;
  ourApproachH2Line2: string;
  ...
  en: {
    ...
    breadcrumbCurrent: 'Digital Marketing',
    badge: 'Digital Marketing',
    h1Line1: 'Your customers are online.',
    h1Line2: 'Is your business reaching them?',
    heroPara: 'Over 859,000 Mauritians are active on social media. Another million search Google every day. We help your business show up in the right place, at the right time, in front of the right people.',
    ctaPrimary: 'Book a Free Strategy Call',
    ctaWhatsApp: 'Chat on WhatsApp',
    trust1: 'Tailored strategy for Mauritius',
    trust2: 'Monthly performance reports',
    trust3: 'No long-term contracts required',
    trust4: 'Transparent, no hidden fees',
    statsItems: [
    ...
    whyH2Line1: 'Every day offline',
    whyH2Line2: 'is a day lost.',
    whyStats: [
    ...
    whyCallout: 'Your customers wake up and check their phones. They scroll Facebook on their lunch break. They search Google before buying anything.',
    whyCalloutBold: 'If your business is not showing up — a competitor is.',
    whatWeDoBadge: 'What We Do',
    whatWeDoH2Line1: 'Full-service digital',
    whatWeDoH2Line2: 'marketing for SMEs.',
    whatWeDoPara: 'We handle the channels that matter — so you can focus on running your business.',
    services: [
      {
    ...
    industriesBadge: 'Industries We Work With',
    industriesH2: 'We know your sector.',
    industriesPara: 'Every industry communicates differently. We write, design, and target for your specific market.',
    industries: ['Hospitality & Tourism', 'Restaurants & Food', 'Retail & E-commerce', 'Professional Services', 'Tech & Startups', 'Education & Training'],
    ourApproachBadge: 'Our Approach',
    ourApproachH2Line1: 'Strategy first.',
    ourApproachH2Line2: 'Results always.',
    process: [
      { step: '01', title: 'Discovery & Audit', desc: 'We analyse your current digital presence, competitors, and target audience to understand where the opportunities are.' },
      { step: '02', title: 'Strategy', desc: 'We build a clear, tailored action plan with channels, content themes, and goals aligned to your business.' },
      { step: '03', title: 'Execution', desc: 'We create and publish content, launch campaigns, and manage your channels consistently every month.' },
      { step: '04', title: 'Optimise & Report', desc: 'Monthly performance reports with clear insights. We refine the strategy based on what the data shows.' },
    ],
    ...
    contactBadge: 'Free Strategy Call',
    contactH2Line1: "Let's talk about",
    contactH2Line2: 'growing your business.',
    contactPara: 'A free, no-pressure call or visit. We audit your current digital presence, identify the biggest opportunities, and tell you exactly what we would do — before any commitment.',
    contactPhoneLabel: 'Phone / WhatsApp',
    contactEmailLabel: 'Email',
    whatsAppBtn: 'Chat on WhatsApp',
    formTitle: 'Book your free strategy session',
    formDropdownLabel: 'Your main goal',
    formDropdownOptions: ['Get more customers / leads', 'Grow my social media presence', 'Improve my Google ranking', 'Launch Google / Meta Ads', 'Build brand awareness', 'Full digital marketing strategy'],
    formMessagePlaceholder: 'What do you sell? Who are your customers? What have you tried so far?',
    formSubmitLabel: 'Book My Free Strategy Call',
  },
  fr: {
    breadcrumbHome: 'Accueil',
    breadcrumbServices: 'Services',
    breadcrumbCurrent: 'Marketing digital',
    badge: 'Marketing digital',
    h1Line1: 'Vos clients sont en ligne.',
    h1Line2: 'Votre entreprise les atteint-elle ?',
    heroPara: 'Plus de 859 000 Mauriciens sont actifs sur les réseaux sociaux. Un million supplémentaire effectue des recherches sur Google chaque jour. Nous aidons votre entreprise à apparaître au bon endroit, au bon moment, devant les bonnes personnes.',
    ctaPrimary: 'Réserver un appel stratégique',
    ctaWhatsApp: 'Écrire sur WhatsApp',
    trust1: 'Stratégie adaptée à Maurice',
    trust2: 'Rapports de performance mensuels',
    trust3: 'Sans engagement à long terme',
    trust4: 'Transparent, sans frais cachés',
    statsItems: [
      { stat: '859K', label: 'Mauriciens actifs sur les réseaux sociaux — 67,7 % de la population' },
      { stat: '79,5 %', label: 'De la population utilise Internet quotidiennement' },
      { stat: '168 %', label: 'Taux de pénétration mobile — la plupart des gens ont plus d\'une SIM' },
      { stat: '88,6 %', label: 'Des ménages possèdent un smartphone' },
    ],
    whyItMattersBadge: 'Pourquoi c\'est important',
    whyH2Line1: 'Chaque jour hors ligne',
    whyH2Line2: 'est un jour perdu.',
    whyStats: [
      { stat: '81 %', label: 'Des consommateurs recherchent une entreprise en ligne avant de visiter ou d\'acheter', color: 'purple' },
      { stat: '×3', label: 'Plus de prospects générés par le marketing de contenu par rapport à la publicité traditionnelle à 62 % de coût en moins', color: 'gold' },
      { stat: 'Moins de 5 %', label: 'De portée organique sur Facebook pour les pages d\'entreprise — sans stratégie, presque personne ne voit vos publications', color: 'purple' },
    ],
    whyCallout: 'Vos clients se réveillent et consultent leur téléphone. Ils font défiler Facebook pendant leur pause déjeuner. Ils recherchent sur Google avant d\'acheter quoi que ce soit.',
    whyCalloutBold: 'Si votre entreprise n\'apparaît pas — c\'est un concurrent qui le fait.',
    whatWeDoBadge: 'Ce que nous faisons',
    whatWeDoH2Line1: 'Marketing digital complet',
    whatWeDoH2Line2: 'pour les PME.',
    whatWeDoPara: 'Nous gérons les canaux qui comptent — pour que vous puissiez vous concentrer sur votre activité.',
    services: [
      {
        title: 'Gestion des réseaux sociaux',
        desc: 'Nous créons, planifions et gérons votre présence sur Facebook, Instagram et LinkedIn pour que votre marque reste visible et engageante — sans que vous passiez des heures sur votre téléphone.',
        tags: ['Création de contenu', 'Community management', 'Calendrier mensuel'],
      },
      {
        title: 'Référencement naturel (SEO)',
        desc: 'Lorsque quelqu\'un cherche ce que vous proposez à Maurice, nous faisons en sorte que votre entreprise apparaisse — et non un concurrent. Le SEO est un investissement à long terme qui continue de porter ses fruits.',
        tags: ['SEO on-page', 'SEO local', 'Google Business Profile'],
      },
      {
        title: 'Google Ads',
        desc: 'Besoin de prospects rapidement ? Google Ads place votre entreprise en tête des résultats de recherche immédiatement. Nous gérons chaque centime pour maximiser le retour et minimiser les dépenses inutiles.',
        tags: ['Campagnes search', 'Annonces display', 'Suivi du ROI'],
      },
      {
        title: 'Marketing de contenu',
        desc: 'Nous rédigeons des articles de blog, des légendes et des textes web qui parlent à votre audience, construisent la confiance et génèrent du trafic organique sur la durée.',
        tags: ['Rédaction de blog', 'Légendes sociales', 'Copywriting web'],
      },
      {
        title: 'E-mail marketing',
        desc: 'Vos clients existants sont votre meilleur atout. Nous vous aidons à rester en tête de liste avec des campagnes ciblées qui génèrent des ventes récurrentes et des recommandations.',
        tags: ['Campagnes newsletter', 'Automatisation', 'Segmentation'],
      },
      {
        title: 'Rapports & Analyses',
        desc: 'Chaque mois, vous recevez un rapport clair indiquant exactement ce qui fonctionne, ce qui ne fonctionne pas, et où votre budget génère le meilleur retour.',
        tags: ['Rapports mensuels', 'Analyse du trafic', 'Suivi des conversions'],
      },
    ],
    industriesBadge: 'Secteurs avec lesquels nous travaillons',
    industriesH2: 'Nous connaissons votre secteur.',
    industriesPara: 'Chaque industrie communique différemment. Nous rédigeons, concevons et ciblons pour votre marché spécifique.',
    industries: ['Hôtellerie & Tourisme', 'Restaurants & Alimentation', 'Commerce & E-commerce', 'Services professionnels', 'Tech & Startups', 'Éducation & Formation'],
    ourApproachBadge: 'Notre approche',
    ourApproachH2Line1: 'La stratégie d\'abord.',
    ourApproachH2Line2: 'Les résultats toujours.',
    process: [
      { step: '01', title: 'Découverte & Audit', desc: 'Nous analysons votre présence numérique actuelle, vos concurrents et votre cible pour identifier les opportunités.' },
      { step: '02', title: 'Stratégie', desc: 'Nous élaborons un plan d\'action clair et personnalisé avec des canaux, des thèmes de contenu et des objectifs alignés sur votre activité.' },
      { step: '03', title: 'Exécution', desc: 'Nous créons et publions du contenu, lançons des campagnes et gérons vos canaux de manière cohérente chaque mois.' },
      { step: '04', title: 'Optimiser & Rapporter', desc: 'Rapports de performance mensuels avec des insights clairs. Nous affinons la stratégie en fonction de ce que les données nous montrent.' },
    ],
    faqTitle: 'Questions fréquentes',
    faqs: [
      { q: 'Quand verrai-je des résultats ?', a: 'Les annonces payantes (Google Ads) peuvent générer du trafic en quelques jours. Le SEO et les réseaux sociaux organiques prennent plus de temps — généralement 3 à 6 mois pour une croissance significative. Nous sommes transparents sur les délais dès le départ.' },
      { q: 'Ai-je besoin d\'un site web avant de commencer le marketing digital ?', a: 'Pour la gestion des réseaux sociaux, non — vos profils suffisent. Pour Google Ads et le SEO, un site web est indispensable. Nous pouvons en créer ou en optimiser un dans le cadre d\'un forfait combiné.' },
      { q: 'Saurai-je où va mon budget ?', a: 'Oui, entièrement. Vous recevez un rapport mensuel détaillant chaque campagne, ses résultats et la répartition de vos dépenses. Nous croyons en la transparence totale.' },
      { q: 'Gérez-vous également le budget publicitaire ?', a: 'Nous gérons les campagnes, mais le budget publicitaire (ce que vous payez à Google ou Meta) est séparé et payé directement par vous. Cela vous garantit un contrôle et une visibilité totaux sur vos dépenses.' },
      { q: 'Puis-je commencer petit ?', a: 'Absolument. Nous travaillons avec des entreprises à chaque étape. Une présence ciblée sur un ou deux réseaux est souvent le meilleur point de départ pour les PME avec un budget modeste.' },
      { q: 'Y a-t-il une durée minimale de contrat ?', a: 'Nous ne vous engageons pas sur le long terme. Nous méritons votre confiance chaque mois par les résultats. Un minimum de 3 mois est recommandé pour voir une traction significative, mais c\'est une recommandation, pas une condition.' },
    ],
    contactBadge: 'Appel stratégique gratuit',
    contactH2Line1: 'Parlons de',
    contactH2Line2: 'la croissance de votre entreprise.',
    contactPara: 'Un appel ou une visite gratuite et sans pression. Nous auditons votre présence numérique actuelle, identifions les meilleures opportunités et vous disons exactement ce que nous ferions — avant tout engagement.',
    contactPhoneLabel: 'Téléphone / WhatsApp',
    contactEmailLabel: 'E-mail',
    whatsAppBtn: 'Écrire sur WhatsApp',
    formTitle: 'Réservez votre session stratégique gratuite',
    formDropdownLabel: 'Votre objectif principal',
    formDropdownOptions: ['Obtenir plus de clients / prospects', 'Développer ma présence sur les réseaux', 'Améliorer mon classement Google', 'Lancer des annonces Google / Meta', 'Développer la notoriété de ma marque', 'Stratégie de marketing digital complète'],
    formMessagePlaceholder: 'Que vendez-vous ? Qui sont vos clients ? Qu\'avez-vous déjà essayé ?',
    formSubmitLabel: 'Réserver mon appel stratégique gratuit',
  },
};

const SERVICES_ICONS = [Users, Search, MousePointerClick, PenTool, Mail, BarChart3];
const SERVICES_COLORS = ['purple', 'gold', 'purple', 'gold', 'purple', 'gold'];
const INDUSTRY_ICONS = [Hotel, Utensils, ShoppingBag, Building2, Smartphone, Users];
const PROCESS_ICONS = [Target, TrendingUp, Megaphone, LineChart];
    ...
    <main className="min-h-screen bg-cream pt-16 lg:pt-20">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-x-8 gap-y-3 pt-8 border-t border-white/8">
                {[
                  ...
                  { icon: BarChart3,  text: txt.trust2 },
            ...
            {txt.industries.map((label, i) => {
              ...
              return (
                <div key={i}
                  ...
                  <p className="text-navy font-bold text-xs leading-snug">{label}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-24 lg:py-28 bg-navy relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-purple/20 border border-purple/40 text-purple-light font-bold text-xs px-4 py-2 rounded-full mb-4">
              {txt.ourApproachBadge}
            </div>
            <h2 className="text-3xl lg:text-4xl font-black text-white tracking-tight mb-4">
              {txt.ourApproachH2Line1}<br />
              <span className="purple-text">{txt.ourApproachH2Line2}</span>
            </h2>
          </div>
